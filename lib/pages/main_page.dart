...
import 'package:pdf_generator/pages/details_page.dart';
...
class _MainPageState extends State<MainPage> {final bills = <BillModel>[
  BillModel(
...
AppBar _buildAppBar() {
  return AppBar(
    title: const Text('PDF Generator',style: TextStyle(color: Colors.white),),
    centerTitle: true,
  ...
  return ListView(
    children: [
      ...bills.map(
          ...
          onTap: () {
            Get.to(DetailsPage(singleBillItem: e));
